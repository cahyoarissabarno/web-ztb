...
export default function Sidebar(props) {
    ...
    return (
        <>
            ...
            <div className={`md:flex md:static fixed ${toggleNav ? 'flex' : 'hidden'} flex-col w-64 h-screen py-8 border-r bg-blueLogo border-gray-600 z-0`}>
                        ...
                        {props.menu.map((val, i)=>{
                            return(
                                <Link key={i} href={`${val.link}`}>
                                    <a className="flex items-center px-4 py-2 text-gray-700 bg-blueLogo text-gray-200" href="#">
