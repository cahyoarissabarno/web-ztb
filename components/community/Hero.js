...
export default function Hero(props) {
  return (
    <>
      <div className="container max-w-none px-14 flex flex-col py-4 mx-auto space-y-6 lg:h-[37.5rem] lg:py-16 lg:flex-row lg:items-center bg-gray-800">
        ...
        <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
            <div className="max-w-lg lg:mx-14 lg:order-2">
                ...
                <div className="mt-8">
                    <a href="#" className="block px-3 py-2 font-semibold text-center text-gray-800 transition-colors duration-200 transform bg-gray-300 rounded-md lg:inline hover:bg-gray-700 hover:text-gray-300">
