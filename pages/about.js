            ...
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer shadow-lg rounded-xl hover:border-transparent group hover:bg-blueLogo">
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <div className="flex-shrink-0 object-cover w-24 h-24 sm:mx-4 relative">
                                <Image layout='fill' objectFit='cover' className='rounded-full' src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt=""/>
                            </div>
                    ...
                    <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer shadow-lg rounded-xl hover:border-transparent group hover:bg-blueLogo">
                        <div className="flex flex-col sm:-mx-4 sm:flex-row">
                            <div className="flex-shrink-0 object-cover w-24 h-24 sm:mx-4 relative">
                                <Image layout='fill' objectFit='cover' className='rounded-full' src="https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80" alt=""/>
                            </div>
                            <div className="mt-4 sm:mx-4 sm:mt-0">
