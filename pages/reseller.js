...
export default function ReselleHome() {
  ...
  const section6 = [
    {img: '/Webinar-Via-Zoom.webp', title: 'Webinar Via Zoom', desc: 'Penjelasan materi melalui Online, memudahkan untuk kita tetap belajar dimanapun dan kapanpun.'},
    {img: '/Offline-Meeting.webp', title: 'Offline Meeting', desc: 'Bisa ketemu langsung dengan mentor dan juga reseller lainnya untuk sharing dan belajar.'},
    {img: '/Offline-Training.webp', title: 'Offline Training', desc: 'Training berkala sesuai kebutuhan dan materi yang dibawakan oleh para Coach dan Master dibidangnya.'},
  ]

  const section7 = [
    {img: '/Komunitas.webp', title: 'Komunitas', title: 'Komunitas', desc: 'Tergabung bersama Ribuan Reseller lainnya dari seluruh Indonesia.'},
    {img: '/Akses-Bank-Konten.webp', title: 'Akses Bank Konten', desc: 'Mendapatkan Fasilitas Konten Jualan terupdate.'},
    {img: '/Coaching-Class.webp', title: 'Offline Coaching Class', desc: 'Coaching berkala secara offline maupun online bisa kapanpun dan dimanapun.'},
    {img: '/Produk-Pilihan.webp', title: 'Produk Pilihan', desc: 'Produk yang berkualitas dan terjamin original dan teruji Pasar .'},
    {img: '/Member-Area.webp', title: 'Member Area', desc: 'Akses ke Platform Digital khusus Member Area.'},
    {img: '/Inner-Circle.webp', title: 'Inner Circle', desc: 'Masuk ke Inner Circle bersama Coach dan trainer yang sudah berpengalaman di bidangnya.'},
    {img: '/Penghasilan-dari-Rumah.webp', title: 'Penghasilan dari Rumah', desc: 'Anda dapat mendapatkan penghasilan jutaan hanya dari Rumah.'},
  ]

  const section8 = [
    {img: '/testi1.png'}, {img: '/testi2.png'}, {img: '/testi3.png'}, {img: '/testi4.png'}, 
    {img: '/testi5.png'}, {img: '/testi6.png'}, {img: '/testi7.png'}, {img: '/testi8.png'}
  ]
  ...
  return (
    <>
      ...
      <div style={{ backgroundImage: "url('/bg-blue-newww.webp')"}} className="container bg-cover bg-right-bottom max-w-none md:px-14 px-6 flex flex-col py-4 mx-auto space-y-6 lg:h-[42rem] py-16 md:flex-row md:items-center bg-blueLogo">
          ...
          { section3.map((item, i)=>{
              return (
                <div key={i} className="px-3 py-5 md:w-48 flex flex-col">
                  <div style={{ backgroundImage: "url('/bg-blue-newww.webp')"}} className="w-16 h-16 bg-cover inline-flex items-center justify-center rounded-full bg-gray-100 text-gray-500 mb-3 flex-shrink-0">
                    {item.icon}
                  </div>
      ...
      <div className='container p-10 mx-auto text-center'>
        ...
        <div className='flex flex-wrap justify-center my-10'>
          { section8.map((item, i)=>{
            return(
              <div key={i} className="mx-4 my-3 h-64 w-64 grid max-w-xs mx-auto border-solid border-2 rounded-md shadow-xl">
      ...
      <div className='grid justify-items-center container max-w-none p-10 my-10'>
        ...
        <div className='grid md:grid-cols-2 grid-cols-1 gap-5 my-10'>
          <div className='object-cover object-right mx-auto my-8'>
            <Image layout='intrinsic' width={300} height={450} objectFit='cover' 
            src="/book.webp"/>
          </div>
          <div className='md:p-7 mt-12'>
