      ...
      <section className="text-gray-600 body-font bg-gradient-to-b from-white to-gray-200">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="text-gray-700 md:text-4xl md:mx-14 px-14 text-3xl px-5 font-bold text-center pb-6">Yang Anda Dapatkan Saat Menjadi Reseller</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven&apos;t heard of them.</p>
          </div>
          <div className="flex flex-wrap -m-4 mb-20 mx-20">
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <div className='flex-shrink-0 w-48 h-48 object-cover object-center sm:mb-0 mb-4'>
                  <Image layout='intrinsic' width={550} height={550} objectFit='cover' alt="team" className="rounded-lg" src="https://dummyimage.com/200x200"/>
                </div>
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font font-medium text-lg text-gray-900">Member Area</h2>
            ...
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <div className='flex-shrink-0 w-48 h-48 object-cover object-center sm:mb-0 mb-4'>
                  <Image layout='intrinsic' width={550} height={550} objectFit='cover' alt="team" className="rounded-lg" src="https://dummyimage.com/201x201"/>
                </div>
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font font-medium text-lg text-gray-900">Produk Pilihan</h2>
                  <p className="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                </div>
              </div>
            </div>
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <div className='flex-shrink-0 w-48 h-48 object-cover object-center sm:mb-0 mb-4'>
                  <Image layout='intrinsic' width={550} height={550} objectFit='cover' alt="team" className="rounded-lg" src="https://dummyimage.com/204x204"/>
                </div>
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font font-medium text-lg text-gray-900">Coaching Class</h2>
                  <p className="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                </div>
              </div>
            </div>
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <div className='flex-shrink-0 w-48 h-48 object-cover object-center sm:mb-0 mb-4'>
                  <Image layout='intrinsic' width={550} height={550} objectFit='cover' alt="team" className="rounded-lg" src="https://dummyimage.com/206x206"/>
                </div>
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font font-medium text-lg text-gray-900">Komunitas</h2>
                  <p className="mb-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                </div>
              </div>
            </div>
          ...
          <section className="bg-white dark:bg-gray-800 mt-14 rounded-3xl">
