...
export default function OwnerHome() {
  ...
  return (
    <>
      ...
      <div style={{ backgroundImage: "url('/bg-blue-newww.webp')"}} className="container bg-cover max-w-none px-14 flex flex-col py-4 mx-auto space-y-6 lg:h-[42rem] py-16 md:flex-row md:items-center bg-blueLogo">
            ...
            { section2.map((item, i)=>{
              return (
                <div key={i} className="p-4 md:w-48 flex flex-col text-center items-center">
                  <div style={{ backgroundImage: "url('/bg-blue-newww.webp')"}} className="w-24 h-24 bg-cover inline-flex items-center justify-center rounded-full bg-gray-100 text-gray-500 mb-3 flex-shrink-0">
                    {item.icon}
                  </div>
      ...
      <div className='container max-w-none bg-gray-100 p-10 my-14 mx-auto grid md:grid-cols-2 grid-cols-1'>
        <div className='text-center py-10'>
          ...
          <p className='font-bold text-3xl md:mx-6 mt-6 tracking-tighter'>Bekerja sama dengan perusahaan yang sangat besar dan kuat</p>
        </div>
      ...
      {/* Section6 */}
      <div className='container max-w-none md:p-20 p-10 my-14 mx-auto grid md:grid-cols-2 grid-cols-1'>
        ...
        <div className='flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 justify-center py-10 px-14'>
      ...
      <div className='container max-w-none my-14 mx-auto grid md:grid-cols-2 grid-cols-1'>
        ...
        <div className='flex flex-wrap justify-center py-10 md:px-14 px-7'>
          <p className='md:text-5xl text-3xl font-bold text-gray-800 tracking-tighter leading-snug'>
            Adanya organisasi pendukung
          </p>
      ...
      {/* Section8 */}
      <div className='container bg-cover bg-right max-w-none relative' style={{ backgroundImage: "url('/seminar.jpg')"}}>
      ...
      {/* Section9 */}
      <div className='container max-w-none md:p-32 p-10 my-14 mx-auto grid md:grid-cols-3 grid-cols-1'>
        <div className='text-center'>
      ...
      <div className='container mx-auto p-10 text-center'>
        ...
        <div className="conatiner p-10">
          <Slider {...settings}>
            <div className="px-5 object-cover relative">
              <Image layout='intrinsic' width={550} height={550} objectFit='cover' src='https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60' />
            </div>
            <div className="px-5 object-cover relative">
              <Image layout='intrinsic' width={550} height={550} objectFit='cover' src='https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60' />
            </div>
      ...
      <div className='container max-w-none mx-auto my-28'>
        {/* Section11 */}
        <div className='md:w-2/3 w-3/4 mx-auto bg-cover bg-right my-16 shadow-xl rounded-lg' style={{ backgroundImage: "url('/bg-youtube.webp')"}}>
          <div className='grid md:grid-cols-2 grid-cols-1 p-8 bg-no-repeat bg-right' style={{ backgroundImage: "url('/youtube.webp')"}}>
            <div>
        ...
        {/* Section12 */}
        <div className='md:w-2/3 w-3/4 mx-auto bg-cover bg-right my-16 shadow-xl rounded-lg' style={{ backgroundImage: "url('/bg-zoom.webp')"}}>
          <div className='grid md:grid-cols-2 grid-cols-1 p-8 bg-no-repeat bg-right' style={{ backgroundImage: "url('/zoom.webp')"}}>
            <div>
              <p className='text-4xl py-3 text-gray-900 font-bold tracking-tight'>Penjelasan Singkat</p>
              <p className='text-xl py-3 text-gray-900 font-normal tracking-tight'>Klik tombol dibawah ini untuk menyaksikan video penjelasan singkat, sebelum anda memulai perjalanan bisnis Anda</p>
